...
export const TrophyIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 011.016-5.71 1.5 1.5 0 013.192.422 9.75 9.75 0 015.78 5.288zM12 21a9 9 0 100-18 9 9 0 000 18z" />
...
export const UsersIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.928A3 3 0 007.5 12.5a3 3 0 00-3 3v.5a3 3 0 003 3a3 3 0 003-3v-.5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12.5 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const FaceSmileIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
